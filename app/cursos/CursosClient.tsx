        ...
        <main className="plenum-site bg-[#F1F1F1] text-[#030D1F] min-h-screen">
            ...
            <div className="max-w-[1280px] mx-auto px-4 pt-10 relative z-20">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 lg:gap-6 mb-14">
                            {filtered.map((course) => (
                                <a key={course.id} href={course.url} className="group relative block h-[450px] sm:h-[490px] lg:h-[520px] rounded-[20px] sm:rounded-[24px] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.25)] hover:shadow-[0_24px_60px_rgba(0,0,0,0.3),0_0_0_2px_rgba(201,162,39,0.55),0_0_32px_rgba(201,162,39,0.35)] hover:-translate-y-1 transition-all duration-300 cursor-pointer">
                                    <img src={course.image} alt={course.title} className="absolute inset-0 w-full h-full object-cover group-hover:brightness-[1.12] transition-[filter] duration-300" draggable={false} />
