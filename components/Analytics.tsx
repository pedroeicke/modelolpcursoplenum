...
export default function Analytics() {
  ...
  // ids com prefixo: o navegador expõe elemento com id como variável global, e um
  // <script id="clarity"> virava window.clarity e impedia o Clarity de iniciar.
  return (
    <>
      <Script src={`https://www.googletagmanager.com/gtag/js?id=${GA_ID}`} strategy="afterInteractive" />
      <Script id="plenum-ga4" strategy="afterInteractive">
        {`window.dataLayer = window.dataLayer || [];
function gtag(){dataLayer.push(arguments);}
gtag('js', new Date());
gtag('config', '${GA_ID}');`}
      </Script>
      <Script id="plenum-gtm" strategy="afterInteractive">
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
      ...
      <Script id="plenum-clarity" strategy="afterInteractive">
